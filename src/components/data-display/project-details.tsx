...
const ProjectDetails = ({
  ...
  return (
    <Card className="glowing-border-light mx-auto flex w-full max-w-6xl flex-col md:flex-row">
      {/* Image */}
      <div
        className={mergeClasses(
          ...
          'flex items-center justify-center border-gray-100 bg-gray-50 p-8 max-md:rounded-t-3xl md:w-1/2 lg:p-12',
          layoutType === 'default'
            ? 'md:rounded-l-3xl md:border-r'
            : 'md:order-last md:rounded-r-3xl md:border-l'
        )}
      >
