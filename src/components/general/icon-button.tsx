...
const iconButtonVariants = cva(
  'flex justify-center items-center hover:bg-white active:bg-white rounded-lg p-1.5 transition-colors duration-200 [&_svg]:stroke-gray-600 [&_svg]:hover:stroke-gray-700',
  {
    variants: {
      size: {
